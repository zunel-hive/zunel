...
mod tests {
    ...
    /// text content. Slice 1 of Mode 2 needs this to surface helper
    /// session ids; this test pins the dispatcher's contract that
    /// `_meta` lands as a sibling of `content`/`isError` so MCP
