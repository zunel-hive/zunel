...
//! The tokenizer is hardcoded to `cl100k_base`, matching Python's
//! default for OpenAI-compatible models. If a provider ships its own
//! native tokenizer it overrides via `estimate_prompt_tokens_chain`.

use serde_json::Value;
use tiktoken_rs::cl100k_base_singleton;

/// Approximate message-format overhead, matching OpenAI's documented
/// `tokens_per_message = 3` for gpt-3.5+ cl100k models and Python
/// zunel's `estimate_message_tokens`.
