...
from zunel.config.loader import load_config, save_config
from zunel.security.network import validate_url_target
...
def test_onboard_does_not_crash_with_legacy_memory_window(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("zunel.config.loader.get_config_path", lambda: config_path)
    monkeypatch.setattr("zunel.cli.commands.get_workspace_path", lambda _workspace=None: workspace)
...
def test_onboard_refresh_backfills_missing_channel_fields(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("zunel.cli.commands.get_workspace_path", lambda _workspace=None: workspace)
    monkeypatch.setattr(
        "zunel.channels.registry.discover_all",
        lambda: {
            "qq": SimpleNamespace(
