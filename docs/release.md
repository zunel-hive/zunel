...
Two CI workflows live in `zunel-hive/zunel`:

- `.github/workflows/release.yml` — generated by [`cargo-dist`][dist],
  with hand-patched additions. Triggered on tags matching
  `**[0-9]+.[0-9]+.[0-9]+*` (so `v0.2.0`, `0.2.0`,
  `app/v1.0.0-rc.1`, etc. all match). Jobs in order:
