...
This directory contains built-in skills that extend zunel's capabilities.
...
When skills reference large local documentation or logs, prefer zunel's built-in
