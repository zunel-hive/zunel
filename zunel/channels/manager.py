...
from zunel.utils.restart import consume_restart_notice_from_env, format_restart_completed_message
...
class ChannelManager:
    ...
    Responsibilities:
    - Initialize enabled channels discovered at runtime
    - Start/stop channels
    ...
    def _init_channels(self) -> None:
        """Initialize enabled built-in channels discovered from the package."""
