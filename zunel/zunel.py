"""High-level programmatic interface to zunel."""
...
class Zunel:
    """Programmatic facade for running the zunel agent.
    ...
    def from_config(
        ...
        *,
        ...
        from zunel.config.loader import (
        ...
        previous_config_path = get_active_config_path()
...
def _make_provider(config: Any) -> Any:
    ...
    if provider_name == "codex":
        ...
        if not (p and p.api_key):
            raise ValueError(
                "No API key configured. Set providers.custom.apiKey in config."
            )
