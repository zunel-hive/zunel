...
from zunel.utils.helpers import ensure_dir, estimate_message_tokens, estimate_prompt_tokens_chain, strip_think
...
class Dream:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        from zunel.agent.tools.filesystem import EditFileTool, ReadFileTool, WriteFileTool
