...
from zunel.agent.tools.schema import BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema
from zunel.agent.tools import file_state
from zunel.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from zunel.utils.document import extract_text
