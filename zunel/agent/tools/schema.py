"""JSON Schema fragment types: all subclass :class:`~zunel.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~zunel.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~zunel.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~zunel.agent.tools.base.Schema`.
...
from zunel.agent.tools.base import Schema
