...
[![CI](https://github.com/rdu16625/zunel/actions/workflows/rust-ci.yml/badge.svg?branch=main)](https://github.com/rdu16625/zunel/actions/workflows/rust-ci.yml)
[![Release](https://img.shields.io/github/v/release/rdu16625/zunel?include_prereleases&sort=semver&display_name=tag&color=blue)](https://github.com/rdu16625/zunel/releases)
...
- OpenAI-compatible providers via `providers.custom`
- ChatGPT Codex via your local `codex` CLI OAuth login
...
brew tap rdu16625/tap && brew install zunel
...
See [`docs/quick-start.md`](docs/quick-start.md) for the full install /
first-run walkthrough and [`docs/release.md`](docs/release.md) for the
maintainer-side release process (tagging, brew tap publish, .deb build).
...
This repository now ships the Rust implementation only. Supported surfaces:
